class CadastrosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @cadastro.save
        format.html { redirect_to @cadastro, notice: 'Cadastro realizado com sucesso!' }
  ...
  def destroy
    @cadastro.destroy
    respond_to do |format|
      format.html { redirect_to cadastros_url, notice: 'Cadastro excluido com sucesso!' }
  ...
  private
    ...
    def cadastro_params
      params.require(:cadastro).permit(:Nome, :Descricao, :Casa, :Mascote, :Rival, :Tecnico, :Cidade, :Estado)
    end
end
